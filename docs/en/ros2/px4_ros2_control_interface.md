...
This setpoint is streamed to the PX4 [_FwLateralLongitudinalControl_ module](../modules/modules_controller.md#fw_lateral_longitudinal_control), which decouples lateral and longitudinal inputs while ensuring that vehicle limits are respected.
